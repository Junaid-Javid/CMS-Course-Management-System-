      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <form name="marks_form" method="post" action="updateMarks"  class="mt-2 p-4 bg-light shadow" onsubmit="return validation_marks()" >
            <h4 class="mb-5 text-secondary">Update Marks</h4>
