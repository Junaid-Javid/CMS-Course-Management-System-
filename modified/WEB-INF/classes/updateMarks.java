...
public class updateMarks extends HttpServlet {
  ...
  String ofinal=request.getParameter("ofinal");
    ...
    out.println("<html>");
    out.println("<head><title>UPDATE MARKS</title><link rel='stylesheet' href='css/bootstrap.min.css'/></head>");
    ...
    }else
{
  ...
  try
  {
    ...
    String query1="Select * from marks where signup_id='"+signup_id+"' ";
  ...
  if(check1==true && check2==true )
    {
      String query = "UPDATE marks SET oquiz='"+oquiz+"',   oassignment='"+  oassignment +"' , oproject='"+oproject+"', omid='"+omid+"', ofinal='"+ofinal+"' where courses='"+courses+"' AND signup_id='"+signup_id+"'";
