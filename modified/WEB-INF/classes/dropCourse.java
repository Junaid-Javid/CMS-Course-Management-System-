  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    response.setContentType("text/html");
     ...
     String signup_id=request.getParameter("signup_id"); 
      ...
      out.println("<html>");
      out.println("<head><title>DROP COURSE</title><link rel='stylesheet' href='css/bootstrap.min.css'/></head>");
...
try
{
     ...
     String query="Delete from add_course where (signup_id='"+signup_id+"' AND courses='"+courses+"')  ";
     int rs = st.executeUpdate(query);
     if(rs==1)
     {
       out.println("<h1 class='text-center'>COURSE Droped Successfully</h1>"); 
       String query1="UPDATE history SET status='DROPPED' where courses='"+courses+"' AND signup_id= '"+signup_id+"'";
      ...
      String query3="Delete from marks where (signup_id='"+signup_id+"' AND courses='"+courses+"')  ";
