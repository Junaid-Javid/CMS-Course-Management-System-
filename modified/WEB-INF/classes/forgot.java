...
public class forgot extends HttpServlet {
  ...
  //Process the HTTP Get request
    ...
    out.println("<html>");
    out.println("<head><title>FORGOT PASSWORD</title><link rel='stylesheet' href='css/bootstrap.min.css'/></head>");
  ...
  try
  {
     ...
     {
       out.println("<div style='background-color:red; height:100px;'><h1 class='text-center p-4'>Email Doesnot Exist </h1></div>");
    	 out.println("<a href='forgot.html'><button class='btn btn-primary ms-3'>Back To Forgot Username/Password</button></a>");
       out.println("<br/><br/><a href='signup.html'><button class='btn btn-primary ms-3'>Back to LogIn Page</button></a>");    
     }
           st.close();
           con.close();
